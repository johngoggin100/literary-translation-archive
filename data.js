...
Now they were gone.`,[],[]),
      ...
      },
      {
        ...
        passages:[
          {
            label:`Epigraph — Pierre at Borodino`,
            cols:[
              col(`tolstoy-wp-garnett`,`Constance Garnett`,1904,`The foundational translation`,`garnett-wp`,['Prose','Classic'],
...
had all been a striving toward this simple thing.`,[],[]),
              col(`tolstoy-wp-maude`,`Louise & Aylmer Maude`,1922,`Oxford standard`,`maude-wp`,['Prose'],
                `During the first weeks of his stay in Petersburg, Pierre felt the whole trend of thought
he had formed during his solitary life quite overshadowed
by the trifling cares which engulfed him in that city.
On returning home in the evenings he would jot down in his notebook
four or five unavoidable calls or appointments for definite hours,
and the mechanics of his life, demanding that his time be employed,
so harassed him that he ceased to have time for reflection.
He simply did not have time to think.`,[],[]),
              col(`tolstoy-wp-pvk`,`Pevear & Volokhonsky`,2007,`Major contemporary version`,`pvk-wp`,['Prose','Contemporary'],
...
with a man who had no name.`,[],[]),
              col(`tolstoy-wp-briggs`,`Anthony Briggs`,2005,`Penguin; praised for narrative drive`,`briggs-wp`,['Prose','Contemporary'],
